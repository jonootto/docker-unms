FROM  ubnt/unms:2.3.35 as unms
FROM  ubnt/unms-nginx:2.3.35 as unms-nginx
FROM  ubnt/unms-netflow:2.3.35 as unms-netflow
FROM  ubnt/unms-crm:4.3.2 as unms-crm
FROM  ubnt/unms-siridb:2.3.35 as unms-siridb
FROM  ubnt/unms-postgres:2.3.35 as unms-postgres
